...
# Define calculate_shipping_cost function:
...
# Uncomented will test the function by calling
...
def calculate_driver_cost(distance, *drivers):
    ...
    for driver in drivers:
        ...
        if cheapest_driver == None:
            # this likely means this is the first driver
...
# Uncommented will test the function by calling
